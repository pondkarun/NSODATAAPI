            ...
            {mode ?
                <>
                    <Badge.Ribbon text={rawdata.maintainer.substring(0, 15) + "..."} color={"#F54"}>
                        <div style={{ cursor:"pointer",position: "relative", border: "2px solid transparent", height: '15em', width: '100%', minHeight: "200px", borderRadius: "10px", backgroundColor: "#F9EAC9", display: 'flex', flexDirection: "column", justifyContent: "center" }}>
                        ...
                        <a title={title} style={{ fontWeight: "bold" }}>{title.substring(0, 25) + "..."}</a>
                    </Badge.Ribbon>
                </>
                :
